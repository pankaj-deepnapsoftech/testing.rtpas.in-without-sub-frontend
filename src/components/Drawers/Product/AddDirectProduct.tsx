          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Select
                ...
                options={[
                  ...categoryOptions,
                  { value: "__add_new__", label: "+ Add new Inventory Type" },
                ]}
            ...
            <FormControl className="mt-3 mb-5" isRequired>
              ...
              <Select
                ...
                options={[
                  ...uomOptions,
                  { value: "__add_new__", label: "+ Add new UOM" },
                ]}
                onChange={(selected: any) => {
                  if (selected?.value === "__add_new__") {
                    const newUnit = prompt("Enter new UOM (e.g. bundle):")
                      ?.trim()
                      .toLowerCase();
                    if (!newUnit) {
                    ...
                    const confirmed = window.confirm(
                      `Are you sure you want to add "${newUnit}" as a new UOM?`
                    );
                    if (!confirmed) return;
